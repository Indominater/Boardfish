...
var EyedropperDebug = (() => {
  ...
  const stats = {
    ...
    prewarmCandidates: 0,
    prewarmReady: 0,
    prewarmDeferredDuringSampling: 0,
  ...
  function runtimeState(options = {}) {
    ...
    const out = {
      ...
      wallpaperReady: !!eyedropperWallpaperReady,
      wallpaperCanRead: eyedropperWallpaperCanRead ?? '',
      wallpaperW: eyedropperWallpaperCanvas?.width || '',
      wallpaperH: eyedropperWallpaperCanvas?.height || '',
