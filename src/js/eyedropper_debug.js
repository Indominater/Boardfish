...
var EyedropperDebug = (() => {
  ...
  function imageSwitchRuntimeState(key) {
    ...
    return {
      ...
      nativeDecodeReady: key ? indominaterGreedyEyedropperNativeDecodePrewarm.ready.has(key) : '',
      nativeDecodeActive: key ? indominaterGreedyEyedropperNativeDecodePrewarm.active.has(key) : '',
      nativeDecodeFailed: key ? indominaterGreedyEyedropperNativeDecodePrewarm.failed.has(key) : '',
  ...
  function runtimeState(options = {}) {
    ...
    const out = {
      ...
      pendingSampleEvent: !!_eyedropperPendingSampleEvent,
      safeImagePending: eyedropperSafeImagePromises.size,
      safeDisplayReloadPending: 0,
      safeScaledPending: eyedropperSafeScaledBitmapPending.size,
      safeImageCacheEntries: eyedropperSafeImageCache.size,
      safeScaledCacheEntries: eyedropperSafeScaledBitmapCache.size,
      nativeDecodeWarmActive: indominaterGreedyEyedropperNativeDecodePrewarm.active.size,
      nativeDecodeWarmReady: indominaterGreedyEyedropperNativeDecodePrewarm.ready.size,
      nativeDecodeWarmFailed: indominaterGreedyEyedropperNativeDecodePrewarm.failed.size,
      viewportScaleQueueLength: typeof imageScaledVariantQueue !== 'undefined' ? imageScaledVariantQueue.length : '',
