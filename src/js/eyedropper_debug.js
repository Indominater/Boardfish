...
var EyedropperDebug = (() => {
  ...
  function runtimeState(options = {}) {
    ...
    const out = {
      ...
      nativeDecodeWarmActive: eyedropperNativeDecodePrewarm.active.size,
      nativeDecodeWarmReady: eyedropperNativeDecodePrewarm.ready.size,
      nativeDecodeWarmFailed: eyedropperNativeDecodePrewarm.failed.size,
      viewportScaleQueueLength: typeof imageScaledVariantQueue !== 'undefined' ? imageScaledVariantQueue.length : '',
